...
import { Truck, ShieldCheck, PackageCheck, Phone, ShoppingBag } from 'lucide-react';
                    ...
                    <button
                      ...
                      onClick={() => {
                        cart.add({
                          ...
                          image: p.image_url ?? null, variantLabel: v.label, price: v.price,
                        });
                        toast.success('Ajouté au panier', { description: `${p.name} · ${v.label}` });
                      }}
                      className="mt-2 inline-flex items-center justify-center gap-2 rounded-sm border border-ink bg-background px-3 py-2 text-[11px] font-medium uppercase tracking-[0.15em] text-ink transition hover:bg-ink hover:text-background"
                    >
